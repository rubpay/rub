...
BOOST_AUTO_TEST_CASE(block_subsidy_test)
{
    ...
    nPrevHeight = 4249;
    nSubsidy = GetBlockSubsidyInner(nPrevBits, nPrevHeight, chainParams->GetConsensus(), /*is_v20_active_override=*/false);
    ...
    nPrevBits = 0x1c4a47c4;
    nPrevHeight = 4249;
    nSubsidy = GetBlockSubsidyInner(nPrevBits, nPrevHeight, chainParams->GetConsensus(), /*is_v20_active_override=*/true);
