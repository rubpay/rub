...
namespace GUIUtil {
// Must correspond to index position in AVAILABLE_FONTS
...
void setFont(const std::vector<QWidget*>& vecWidgets, FontFamily family, FontWeight weight, int nPointSize = -1,
             bool fItalic = false);
